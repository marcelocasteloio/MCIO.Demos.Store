...
public class NotificationPingGrpcOperationResiliencePolicy
    : ResiliencePolicyBase,
    INotificationPingGrpcOperationResiliencePolicy
{
    protected override void ConfigureInternal(ResiliencePolicyOptions options)
    {
        options
            .WithCustomIdentificationOptions(
                name: nameof(NotificationPingGrpcOperationResiliencePolicy)
            )
