namespace MCIO.Demos.Store.Notification.WebApi.Factories;
...
public static class ExecutionInfoFactory
{
    ...
    // Public Methods
    public static Core.ExecutionInfo.ExecutionInfo? Create(Commom.Protos.V1.ExecutionInfo? executionInfo)
    {
    ...
    public static Commom.Protos.V1.ExecutionInfo Create(Core.ExecutionInfo.ExecutionInfo executionInfo)
    {
